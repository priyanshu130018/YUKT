    ...
    <MainLayout>
      <div className="max-w-4xl mx-auto px-6 py-20">
        ...
        >
          ...
          <h1 className="text-5xl font-black text-[black] uppercase tracking-tighter italic mb-4">Privacy Policy</h1>
        ...
        <div className="space-y-8">
          <section className="bg-white p-10 rounded-3xl border border-gray-100 shadow-sm">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-[black] text-xl font-black uppercase tracking-tight">Zero Transmission Policy</h2>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <section className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
              <FiEyeOff className="text-black mb-4" size={24} />
              <h3 className="text-[black] font-black text-lg mb-4 uppercase tracking-tight">No Cookies</h3>
            ...
            <section className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
              ...
              <h3 className="text-[black] font-black text-lg mb-4 uppercase tracking-tight">Local Storage</h3>
              <p className="text-gray-500 text-sm leading-relaxed font-medium">
          ...
          <section className="bg-gray-50 p-10 rounded-3xl border border-gray-100 prose prose-slate max-w-none">
            <h3 className="text-[black] font-black uppercase tracking-tight mb-4">Operational Compliance</h3>
