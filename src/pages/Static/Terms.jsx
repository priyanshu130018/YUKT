    ...
    <MainLayout>
      <div className="max-w-4xl mx-auto px-6 py-20">
        ...
        >
          ...
          <h1 className="text-5xl font-black text-[black] uppercase tracking-tighter italic mb-4">Terms of Service</h1>
          <p className="text-gray-500 font-bold uppercase tracking-[0.3em] text-xs">Legal Framework & Usage License</p>
        </motion.div>

        <div className="space-y-12">
          <section className="bg-white p-10 rounded-3xl border border-gray-100 shadow-sm transition-all hover:border-[black]">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <section className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
              ...
              <h3 className="text-[black] font-black text-lg mb-4 uppercase tracking-tight">Disclaimer</h3>
            ...
            <section className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
              <FiShield className="text-black mb-4" size={24} />
              <h3 className="text-[black] font-black text-lg mb-4 uppercase tracking-tight">Data Sovereignty</h3>
              <p className="text-gray-500 text-sm leading-relaxed font-medium">
          ...
          <section className="bg-[black] p-10 rounded-3xl text-white">
