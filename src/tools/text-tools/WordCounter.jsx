  ...
  return (
    <ToolLayout toolId="word-counter">
      <div className="flex-1 flex flex-col p-8 max-w-4xl mx-auto w-full">
        <h2 className="text-[#1a1a1a] dark:text-white text-3xl font-black mb-6 uppercase tracking-tight text-center">Word Counter</h2>
        <textarea value={text} onChange={e=>setText(e.target.value)} placeholder="Type or paste your text here..."
          className="flex-1 min-h-64 p-6 rounded-2xl bg-white dark:bg-zinc-900/40 border border-gray-200 dark:border-[#ffffff10] text-[#1a1a1a] dark:text-white text-lg placeholder-gray-400 focus:ring-2 focus:ring-[#1a1a1a]/10 dark:focus:ring-white/10 outline-none transition-all resize-none mb-6 shadow-inner"/>
