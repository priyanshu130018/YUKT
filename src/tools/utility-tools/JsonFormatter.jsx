  ...
  return (
    <ToolLayout toolId="json-formatter">
      <div className="flex-1 flex flex-col p-8 max-w-5xl mx-auto w-full">
        <h2 className="text-black dark:text-white text-3xl font-black mb-10 uppercase tracking-tight text-center">JSON Structural Reformer</h2>
        <div className="flex gap-3 mb-8 justify-center flex-wrap">
          {[
            ['Format', format, 'bg-[black] text-white dark:bg-white dark:text-black'],
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 flex-1 min-h-[400px]">
          <div className="flex flex-col">
            ...
            <textarea value={input} onChange={e=>{setInput(e.target.value);setOutput('');setError('');}} placeholder='{"key":"value"}' 
              className="w-full h-full p-6 rounded-2xl bg-white dark:bg-white/5 border border-gray-100 dark:border-[#ffffff10] text-black dark:text-white text-xs font-mono placeholder-gray-300 focus:ring-2 focus:ring-[black]/10 dark:focus:ring-white/10 outline-none transition-all resize-none shadow-inner"/>
          </div>
          <div className="flex flex-col">
            ...
            {error
              ...
              :<textarea value={output} readOnly placeholder="Analytically formatted JSON will manifest here..." 
                  className="w-full h-full p-6 rounded-2xl bg-gray-50 dark:bg-[#0a0a0a]/50 border border-gray-100 dark:border-[#ffffff10] text-black dark:text-white text-xs font-mono resize-none shadow-inner"/>}
          </div>
        </div>
      </div>
    </ToolLayout>
